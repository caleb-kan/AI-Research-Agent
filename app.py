...
uri = "mongodb+srv://caleb:Ck1106101234@cluster.b28bo99.mongodb.net/?retryWrites=true&w=majority"
...
def main():
    ...
    if st.checkbox("See people using our Research Agents"):
        ...
        try:
            ...
            st.info("Couldn't get your location, try allowing permissions for accessing location")
        finally:
