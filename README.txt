...
To run this program, you will need to install all the libaries in "requirements.txt", you will also need to generate API keys from OpenAI, Browserless, and Serper. These keys will be used to authenticate your program and allow it to access the respective services.
...
Finally, to run the app, place the command "streamlit run app.py" in your code interpreter terminal and the app should run. 
